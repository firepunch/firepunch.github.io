...
import { flexStyles, fontStyles, spacing } from '../shared/variables'
...
export default function Header() {
  ...
  return (
    <header className={cx(headerStyles.header, headerStyles[customCls])}>
      <a href="/">
        <svg id="firepunch-logo" className={headerStyles.logo} data-name="logo layer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 29.46 29.15">
